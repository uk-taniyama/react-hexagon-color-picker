...
class HexagonalColorPicker extends React.Component<HexagonalColorPickerProps, HexagonalColorPickerState> {
    ...
    componentWillReceiveProps(new_props: any) {
    ...
    _on_color_click = (event: any, color: string) => {
